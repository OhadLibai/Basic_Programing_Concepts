...
public class GreedyAlgorithmTester {
    ...
    public static void mstTest(){
        Graph.Edge s1 = new Graph.Edge(0,1,7);
        Graph.Edge s2 = new Graph.Edge(0,2,8);
        Graph.Edge s3 = new Graph.Edge(1,2,3);
        Graph.Edge s4 = new Graph.Edge(1,3,6);
        Graph.Edge s5 = new Graph.Edge(2,3,4);
        Graph.Edge s6 = new Graph.Edge(1,5,5);
        Graph.Edge s7 = new Graph.Edge(2,5,3);
        Graph.Edge s8 = new Graph.Edge(3,5,2);
        Graph.Edge s9 = new Graph.Edge(5,4,2);
        Graph.Edge s10 = new Graph.Edge(3,4,5);
        Graph k = new Graph(6, Arrays.asList(s1,s2,s3,s4,s5,s6,s7,s8,s9,s10));
        k.greedyAlgorithm();
